...
abstract class AnimeRepository {
  ...
  Future<List<Anime>> upgradeArtwork(List<Anime> anime);
    ...
    Season(
      ...
      episodes: List.generate(
        ...
        (index) => Episode(
          ...
          durationMinutes: 24,
          description:
              'This is an exciting episode where our heroes face new challenges and discover hidden powers. The animation is top-notch.',
    ...
    Season(
      ...
      episodes: List.generate(
        ...
        (index) => Episode(
          ...
          durationMinutes: 24,
          description:
              'The journey continues as darker forces emerge from the shadows. Betrayal and epic battles await in this new chapter.',
          progress: 0.0,
        ),
      ),
    ),
...
Anime _enrichAnime(Anime base) {
  return Anime(
    ...
    description:
        'When the world is threatened by an ancient evil, a young hero must rise and master their hidden potential. Joined by a colorful cast of misfits, they embark on an epic quest to save their realm. Gripping action and stunning animation.',
...
class MockAnimeRepository implements AnimeRepository {
  ...
  @override
  Future<List<Anime>> upgradeArtwork(List<Anime> anime) async => anime;
